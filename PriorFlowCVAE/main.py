    ...
    for num_quadrant_inputs in args.num_quadrant_inputs:
        ...
        if args.allow_baseline_reuse and os.path.exists(
            ...
            if args.dataset == "cifar10":
                baseline_net = baseline.train(
                    ...
                    model_path="baseline_net_q_CIFAR{}.pth".format(num_quadrant_inputs),
                ...
                baseline_net = baseline.train(
                    ...
                    num_epochs=args.num_epochs,
                    early_stop_patience=args.early_stop_patience,
                    model_path="baseline_net_q_fashion{}.pth".format(num_quadrant_inputs),
                    dataset=args.dataset,
                )
            else:
                baseline_net = baseline.train(
        ...
        if args.dataset == "mnist":
            ...
            cvae_net = cvae.train(
                ...
                num_epochs=args.num_epochs,
                early_stop_patience=args.early_stop_patience,
                model_path="cvae_net_q_CIFAR{}{}{}.pth".format(
                    num_quadrant_inputs,
                    "_rand_mask" if args.random_mask else "",
                    "_conv" if args.use_conv else "",
                ),
            ...
            cvae_net = cvae.train(
                ...
                num_epochs=args.num_epochs,
                early_stop_patience=args.early_stop_patience,
                model_path="cvae_net_q_fashion{}{}{}.pth".format(
                    num_quadrant_inputs,
                    "_rand_mask" if args.random_mask else "",
                    "_conv" if args.use_conv else "",
                ),
